...
# of increasing the boot-up time by auto-requiring all files in the support directory.
...
RSpec.configure do |config|
  ...
  # If you're not using ActiveRecord, or you'd prefer not to run each of your examples within a transaction,
